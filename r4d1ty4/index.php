                    ...
                    <table class="table table-hover">
                        ...
                        while ($stmt->fetch()) {
                            ...
                            <tr>
                                ...
                                <td> <img src="../images/<? echo $gambar ?>" class="image img-bordered-sm" width="60" height="50"> </td>
                                <td>
            ...
            <div class="modal-content">
                ...
                <form role="form" id="form">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="fileuploader">Gambar</label>

                            <div id="fileuploader"><i class="fa fa-upload"></i> Upload Gambar</div>
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="javascript:void(0)" type="button" id="btn-tambah" class="btn btn-primary"><i class="fa fa-plus"></i>
                            Tambah</a>
                    </div>
                </form>
            </div>
